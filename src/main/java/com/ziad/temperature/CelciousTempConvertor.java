...
public class CelciousTempConvertor implements TemperatureConvertor{
    ...
    public double convert(FahrenheitTempUnit u) {
        BigDecimal bigDecimal = new BigDecimal((u.getValue() - 32) * 5/9).setScale(2, RoundingMode.HALF_UP);
        return bigDecimal.doubleValue();
    }
